...
#I think we should put the SE for each design in a table, like we made on paper so that they're easy to refer to at any time 
# 'Discuss potential non-sampling, sampling, and non-response errors' (in the Assignment)
...
We cannot sample 1000 / 7 from each EmployerSize category, because we do not have enough in all of the size divisions. Therefore, we have sampled from each size division with equal probability (CHECK! THIS WAS CONFUSING). (We have roughly taken a proportion of 1000/6713 = 14.89% from each size division) 
