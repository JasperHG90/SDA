...
\end{bmatrix}
$$
>>>>>>> 001cab79ee3747c5ad534cd8f286d6da16e84655:report notes.Rmd
...
902, or 13.45%, of UK companies pay a higher median wage to women in comparison to men - a significantly smaller figure than the 5257 companies, or 78.38%, who provide a higher median wage to males. (The remaining 548 companies, or 8.22%, provide an equal median wage). Similarly to the analysis of the mean wage, we can see from the histogram (Figure XX) that the distribution is strongly skewed in favour of higher male income. 
