...
comparedesign <- data.frame(
  "Mean wage gap estimate" = c(svymean(~DiffMeanHourlyPercent, swordesign)[1], 
                               svymean(~DiffMeanHourlyPercent, design=stratdesign_prop, deff=TRUE)[1], 
                               svymean(~DiffMeanHourlyPercent, design=stratdesign_optim, deff=TRUE)[1]), 
  "Standard Error" = c(SE(svymean(~DiffMeanHourlyPercent, swordesign))[1], 
                       SE(svymean(~DiffMeanHourlyPercent, design=stratdesign_prop, deff=TRUE))[1],
                       SE(svymean(~DiffMeanHourlyPercent, design=stratdesign_optim, deff=TRUE)[1])
))         
