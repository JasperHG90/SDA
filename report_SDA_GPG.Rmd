...
[-@UKGOVGPG] <!-- Don't change this line it ensures that the reference at the bottom shows up! -->
...
```{r, fig.pos="H", fig.cap="Proportion of males against females across the UK"}
...
stratdesign_mean <- svymean(~DiffMeanHourlyPercent, design=stratdesign_prop, deff=TRUE)
...
knitr::kable(comparedesign, caption = "Gender gap estimates under different sampling designs",
             col.names = c("Mean wage gap estimate", "SE", "Margin of error"))
```
